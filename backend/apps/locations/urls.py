...
from .views import (
    ProviderMapView, ProviderLocationUpdateView, FacilitiesListView,
    AdminFacilityUpdateView, PublicFacilityPhonesView,
)
...
urlpatterns = [
    ...
    path('facility-phones/', PublicFacilityPhonesView.as_view(), name='public_facility_phones'),
