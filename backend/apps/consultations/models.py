...
class Consultation(models.Model):
    ...
    # AI-generated, sectioned narrative summary of the whole call (markdown).
    # Distinct from the doctor's manual MedicalRecord template — this just
    # summarises what was said. Generated by Groq right after the call ends.
