...
class Consultation(models.Model):
    ...
    # AI-generated, sectioned narrative summary of the whole call. `ai_summary`
    # is the rendered markdown (read-only display); `ai_summary_sections` is the
    # editable {section_key: text} the doctor can edit and submit. Distinct from
    # the manual MedicalRecord template — this just summarises what was said.
    ai_summary = models.TextField(blank=True, default='')
    ai_summary_sections = models.JSONField(blank=True, null=True)
    ai_summary_submitted = models.BooleanField(default=False)
