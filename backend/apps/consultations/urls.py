...
from .views import (
    ...
    ConsultationTranscribeChunkView, ConsultationFinalizeView, ConsultationAISummaryView,
...
urlpatterns = [
    ...
    path('<uuid:pk>/transcribe-chunk/', ConsultationTranscribeChunkView.as_view(), name='consultation_transcribe_chunk'),
    path('<uuid:pk>/finalize/', ConsultationFinalizeView.as_view(), name='consultation_finalize'),
    path('<uuid:pk>/ai-summary/', ConsultationAISummaryView.as_view(), name='consultation_ai_summary'),
